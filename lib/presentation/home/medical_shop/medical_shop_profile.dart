...
class MedicalShopProfile extends StatefulWidget {
  const MedicalShopProfile({super.key});

  @override
  State<MedicalShopProfile> createState() => _MedicalShopProfileState();
}

class _MedicalShopProfileState extends State<MedicalShopProfile> {
  @override
